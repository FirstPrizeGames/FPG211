window.profileTranslations = {
  ko: {
    ...
    "summaryAction.viewUsage": "사용량 보기",
    ...
    "summaryGuide.pricingThreeTitle": "사용량과 함께 비교하세요",
    "summaryGuide.pricingThreeBody": "현재 브라우저 사용량과 필요한 기능을 확인한 뒤 요금제를 선택하는 편이 안전합니다.",
    "summaryGuide.usageOneTitle": "로그인 후에만 계산합니다",
    "summaryGuide.usageOneBody": "사용량은 Google 로그인 상태에서 사이트가 화면에 보이는 동안만 현재 브라우저에서 증가합니다.",
    "summaryGuide.usageTwoTitle": "세 가지 기간을 따로 관리합니다",
    "summaryGuide.usageTwoBody": "5시간, 주간, 월간 한도는 각 기간이 지나면 자동 초기화되며 서버 계정이나 결제 기록과 동기화되지 않습니다.",
    "summaryGuide.usageThreeTitle": "브라우저 기반 기록입니다",
    "summaryGuide.usageThreeBody": "사이트 데이터를 삭제하거나 브라우저를 바꾸면 사용량 기록과 초기화 가능 상태가 달라질 수 있습니다.",
    ...
    "summaryGuide.privacyOneBody": "테마, 언어, 일부 설정과 사용량은 현재 브라우저의 localStorage 등에 저장됩니다.",
  ...
  en: {
    ...
    "summaryAction.viewUsage": "View usage",
    ...
    "summaryGuide.pricingThreeTitle": "Compare plans with usage",
    "summaryGuide.pricingThreeBody": "Review your current browser usage and required features before choosing a plan.",
    "summaryGuide.usageOneTitle": "Usage starts after sign-in",
    "summaryGuide.usageOneBody": "Usage increases in the current browser only while you are signed in with Google and the site is visible.",
    "summaryGuide.usageTwoTitle": "Three separate time windows",
    "summaryGuide.usageTwoBody": "The 5-hour, weekly, and monthly limits reset after their own windows and are not synchronized with an account server or payment history.",
    "summaryGuide.usageThreeTitle": "Records stay in this browser",
    "summaryGuide.usageThreeBody": "Deleting site data or changing browsers can change usage records and reset availability.",
    ...
    "summaryGuide.privacyOneBody": "Theme, language, selected settings, and usage data are stored in localStorage and related browser storage.",
