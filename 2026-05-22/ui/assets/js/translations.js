window.profileTranslations = {
  ko: {
    ...
    "status.eyebrow": "상태 안내",
    "status.title": "사이트 상태 확인 기준을 안내합니다.",
    "status.lead": "이 페이지는 실시간 장애 감지나 가용성 측정을 수행하지 않습니다. 배포 후 확인할 항목과 브라우저별 조건을 정리합니다.",
    "status.overallLabel": "상태 확인 방식",
    "status.overallValue": "실시간 모니터링 미연결",
    "status.updated": "배포 환경의 실제 상태는 접속 후 직접 확인해야 합니다.",
    "status.routesTitle": "공개 경로",
    "status.routesBody": "홈, 설정, 개인정보 처리방침, 업데이트, 검색, 활동, 사이트맵, 신뢰 센터 경로는 배포 후 직접 열어 확인해야 합니다.",
    "status.notificationsTitle": "알림",
    "status.notificationsBody": "브라우저 알림 지원 여부는 사용자의 권한 선택과 브라우저·기기 정책에 따라 달라집니다.",
    "status.storageTitle": "로컬 저장소",
    "status.storageBody": "테마, 언어, 동의, 활동, 구독 관련 선택은 현재 브라우저에만 저장됩니다.",
    "status.shareTitle": "공유 메타데이터",
    "status.shareBody": "공개 페이지에는 Open Graph와 Twitter Card 메타 태그가 포함되도록 구성되어 있습니다.",
  ...
  en: {
    ...
    "status.eyebrow": "Status guide",
    "status.title": "Review how to check the site status.",
    "status.lead": "This page does not perform real-time incident detection or availability monitoring. It lists post-deployment checks and browser-dependent conditions.",
    "status.overallLabel": "Status method",
    "status.overallValue": "No live monitoring connected",
    "status.updated": "Check the deployed site directly to confirm its current state.",
    "status.routesTitle": "Public routes",
    "status.routesBody": "Open Home, Settings, Privacy, Updates, Search, Activity, Sitemap, and Trust Center directly after deployment to verify each route.",
    ...
    "status.shareBody": "Public pages are configured to include Open Graph and Twitter Card metadata.",
    "security.eyebrow": "Security",
