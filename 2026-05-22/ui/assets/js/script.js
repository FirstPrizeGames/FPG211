...
const repairRouteDocumentMismatch = () => {
  ...
  const repairUrl = `${guard.fallback}?v=20260701-accessibility-claims`;
...
const translations = {
  ko: {
    ...
    "search.accessibilityBody": "키보드 이동, 색 대비, 언어, 모바일 표시 기준을 확인합니다.",
    ...
    "accessibility.lead":
      "First Prize Games는 키보드 이동, 명확한 초점 표시, 읽기 대비, 언어 선택, 모바일 표시 기준을 핵심 접근성 기준으로 관리합니다.",
    ...
    "accessibility.keyboardBody":
      "주요 페이지에는 본문으로 바로 이동하는 skip link가 있고, 주요 링크와 버튼에는 focus-visible 표시가 적용됩니다. 설정 모달, 공유, 인쇄, 우클릭 메뉴는 버튼 기반으로 열고 닫을 수 있게 관리합니다.",
    ...
    "accessibility.motionTitle": "시각 효과 기준",
    "accessibility.motionBody":
      "사이트는 과한 블러와 애니메이션을 기본 디자인에서 제한합니다. 기기의 reduced motion 설정을 존중하도록 무거운 전환 효과를 줄이는 방향으로 관리합니다.",
    ...
    "accessibility.actionsBody": "테마, 언어, 접근성 안내, 보안, 프로필, 우클릭 메뉴 설정은 설정 모달에서 관리합니다.",
    ...
    "settings.kidModeBody": "과한 전환 효과와 애니메이션 부담을 줄여 화면을 차분하게 표시합니다.",
    ...
    "settings.accessibilityBody": "키보드 이동, 색 대비, 언어, 모바일 표시 기준을 확인합니다.",
    ...
    "usage.learnDialogBody": "이 한도는 서버 계정이 아니라 현재 브라우저에서만 계산됩니다. 처음 접속한 순간부터 5시간, 주간, 월간 한도가 시작되고, 기간이 지나면 자동으로 새 한도로 초기화됩니다.",
  ...
  en: {
    ...
    "search.accessibilityTitle": "Accessibility",
    "search.accessibilityBody": "Review keyboard navigation, contrast, language, and mobile display standards.",
    "search.privacyTitle": "Privacy Policy",
    ...
    "accessibility.lead":
      "First Prize Games manages keyboard navigation, visible focus, readable contrast, language choice, and mobile display standards as core accessibility standards.",
    ...
    "accessibility.keyboardBody":
      "Primary pages include a skip link to main content, and primary links and buttons use focus-visible styling. Settings modals, share, print, and the custom context menu are managed with button-based controls.",
    ...
    "accessibility.motionTitle": "Visual effects standard",
    "accessibility.motionBody":
      "The site limits heavy blur and animation in the default design. It is managed in a direction that respects device reduced motion preferences by reducing heavy transitions.",
    ...
    "accessibility.actionsBody": "Theme, language, accessibility guidance, security, profile, and context menu settings are managed in the settings modal.",
    ...
    "settings.kidModeTitle": "Kid mode",
    "settings.kidModeBody": "Reduce heavy transitions and animation load so the interface feels calmer.",
    "settings.kidModeOffLevel": "Off",
    "settings.kidModeSoftLevel": "Soft",
    "settings.kidModeStrongLevel": "Strong",
    "settings.accessibilityTitle": "Accessibility guidance",
    "settings.accessibilityBody": "Review keyboard flow, contrast, language, and mobile display standards.",
    ...
    "usage.learnDialogBody": "These limits are calculated only in the current browser, not on a server account. The 5-hour, weekly, and monthly limits start from the moment you first visit, then reset automatically after each window expires.",
