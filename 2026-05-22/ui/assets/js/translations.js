window.profileTranslations = {
  ko: {
    ...
    "search.settingsBody": "테마, 언어, 우클릭 메뉴, 저장용량 설정을 관리합니다.",
    ...
    "aria.updatesCategories": "업데이트 분류",
    ...
    "accessibility.lead":
      "First PrizeGames는 키보드 이동, 명확한 초점 표시, 읽기 대비, 언어 선택, 모바일 표시 기준을 핵심 접근성 기준으로 관리합니다.",
    ...
    "terms.lead":
      "First PrizeGames 사이트를 이용할 때 적용되는 기본 조건, 외부 서비스 경계, 사용자 책임, 변경 기준을 안내합니다.",
    ...
    "terms.localBody":
      "테마, 언어, 접근성, 프로필, 우클릭 메뉴 같은 설정은 같은 브라우저의 localStorage에 저장됩니다. Settings 또는 Usage 페이지에서 사이트 데이터를 정리할 수 있습니다.",
    ...
    "settings.kidModeOn": "모션 줄이기 켜짐",
    "settings.kidModeOff": "모션 줄이기 꺼짐",
    ...
    "settings.cookieDialogBody": "필수 사이트 기능은 항상 유지됩니다. 이 브라우저에 안내 확인 선택을 저장할지만 정할 수 있습니다.",
    ...
    "pricing.simpleFreeThree": "로그인 후 5시간 및 주간 사용 한도",
    ...
    "pricing.simpleProThree": "우선 지원과 업데이트 안내",
    ...
    "pricing.adaptiveNote": "사용 한도는 로그인 상태에서 사이트가 보이는 동안 현재 브라우저에서만 계산됩니다. Pro 결제도 Google 로그인 후 진행되며, 최종 금액은 Stripe에서 확인됩니다.",
    ...
    "pricing.faqOneAnswer": "Pro는 Google 로그인 후 Stripe checkout 링크로 진행되고, Team은 로그인 없이 예약 문의 흐름으로 진행됩니다.",
    ...
    "about.routeSettings": "테마, 언어, 접근성, 보안, 프로필, 우클릭 메뉴 설정",
    ...
    "about.trustControlBody": "설정에는 개인정보, 프로필, 인터페이스 제어가 포함됩니다.",
  ...
  en: {
    ...
    "search.settingsTitle": "Settings",
    "search.settingsBody": "Manage theme, language, context menu, and storage settings.",
    "search.accessibilityTitle": "Accessibility",
    ...
    "aria.updatesCategories": "Update categories",
    ...
    "accessibility.lead":
      "First PrizeGames manages keyboard navigation, visible focus, readable contrast, language choice, and mobile display standards as core accessibility standards.",
    ...
    "terms.lead":
      "This page explains the basic conditions, external service boundaries, user responsibilities, and update rules for using First PrizeGames.",
    "terms.mediaLabel": "Document scope",
    "terms.mediaValue": "Site access and linked services",
    ...
    "terms.localBody":
      "Theme, language, accessibility, profile, and context menu preferences are stored in localStorage for the same browser. You can clear site data from Settings or Usage.",
    ...
    "settings.kidModeOn": "Reduced motion on",
    "settings.kidModeOff": "Reduced motion off",
    ...
    "settings.languageEnglish": "English",
    "settings.kidModeTitle": "Reduced motion",
    ...
    "settings.cookieDialogBody": "Required site functions always remain available. You can choose only whether this browser remembers the storage notice.",
    ...
    "pricing.simpleFreeThree": "5-hour and weekly limits after sign-in",
    ...
    "pricing.simpleProThree": "Priority support and update notes",
    ...
    "pricing.adaptiveNote": "Usage is calculated in this browser only while you are signed in and the site is visible. Pro checkout also requires Google sign-in, and Stripe confirms the final price.",
    "pricing.summaryCheckout": "Checkout",
    ...
    "pricing.faqOneAnswer": "Pro opens Stripe checkout after Google sign-in. Team keeps a reservation inquiry flow that does not require sign-in.",
    ...
    "about.routeSettings": "Theme, language, accessibility, security, profile, and context menu.",
    ...
    "about.trustControlBody": "Settings include essential privacy, profile, and interface controls.",
