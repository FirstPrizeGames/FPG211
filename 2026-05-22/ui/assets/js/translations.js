window.profileTranslations = {
  ko: {
    ...
    "privacy.lead":
      "First PrizeGames는 계정 생성 없이 읽을 수 있는 사이트이며, 결제 정보와 외부 양식 데이터는 해당 서비스에서 처리됩니다.",
    ...
    "privacy.localBody":
      "이 사이트는 로그인 추적 쿠키나 광고 쿠키를 사용하지 않습니다. 테마, 언어, 접근성, 프로필, 우클릭 메뉴 설정은 이 브라우저의 저장소에 남고, 쿠키 안내 확인 여부만 필요한 경우 쿠키로 저장합니다.",
  ...
  en: {
    ...
    "privacy.lead":
      "First PrizeGames can be read without creating an account, and payment or external form data is handled by the relevant service.",
    "privacy.mediaLabel": "Processing model",
    "privacy.mediaValue": "Local-first, external services",
    ...
    "privacy.localBody":
      "This site does not use login tracking cookies or advertising cookies. Preferences such as theme, language, accessibility, profile, and context menu behavior stay in this browser's storage, and cookie notice acknowledgement may be stored as a cookie when needed.",
